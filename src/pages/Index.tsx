  ...
  const downloads: DownloadPlatform[] = [
    {
      ...
      icon: Monitor,
      versions: [
        { arch: "64-bit", url: "/app/builds/build-windows-x64/Knowlia_1.1.1_x64_en-US.msi", recommended: true },
        { arch: "32-bit", url: "/app/builds/build-windows-x86/Knowlia_1.1.1_x86_en-US.msi", recommended: false }
      ]
    },
   // {
   //   platform: "Linux",
